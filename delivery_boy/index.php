            ...
            <div class="main-panel" style="width:100%;">
               ...
               <footer class="footer">
                  <div class="d-sm-flex justify-content-center justify-content-sm-between">
                     <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2020 <a href="http://homemadefood.atwebpages.com/" target="_blank">Homemade Food</a>. All rights reserved.</span>
                  </div>
               </footer>
               <!-- partial -->
            </div>
